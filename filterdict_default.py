...
'noaa-olr-0-0': {'area': (5000, 1000000), 'angle': (-90., -5.0), 'latextent': (-20,-40), 'ROI': (7.5, 80,-15,-40),'angleROI': (7.5, 80,-23,-33), 'stretch': (100,320), 'thresh': (230,'low'), 'text': "Cloudband" },
'noaa-olr-0-all': {'area': (5000, 1000000), 'angle': False, 'latextent': False, 'ROI': (7.5, 80,-15,-40), 'stretch': (100,320), 'thresh': (230,'low'), 'text': "Cloudband" },
