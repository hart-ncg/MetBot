''' SynopticAnatomy.py: A module of MetBot package\
    ...
    def __mbsmatch__(self,mbs,ch,maxdist=1000e3):
        ...
        for i in xrange(len(mt)-1):
            ...
            for inw in inow:
                ...
                if len(m) > 0:
                    ### Get closest match if many pass distance criterion
                    ixbest = d2nxt.argmin()
                    ixmatch = inxt[ixbest]
